...
class PaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the request
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Must be a non-sanctioned country from /v1/data/countries
     *
     * @return self
     */
     ...
     * Sets payment_url
     *
     * @param string|null $payment_url Hosted checkout URL, redirect buyers to this URL to initiate payment
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param float|null $created_at Unix timestamp when payment request was created
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param float|null $updated_at Unix timestamp when payment request was updated
     *
     * @return self
     */
     ...
     * Gets record
     *
     * @return \Bleumi\Payment\Model\Record|null
     */
     ...
     * Sets record
     *
     * @param \Bleumi\Payment\Model\Record|null $record record
     *
     * @return self
     */
