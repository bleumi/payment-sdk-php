...
/**
 * PaginatedPaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  Bleumi\Payment
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedPaymentRequest';
    ...
    protected static $openAPITypes = [
        'results' => '\Bleumi\Payment\Model\PaymentRequest[]',
        'next_token' => 'string'
    ];
     ...
     * Gets results
     *
     * @return \Bleumi\Payment\Model\PaymentRequest[]
     */
     ...
     * Sets results
     *
     * @param \Bleumi\Payment\Model\PaymentRequest[] $results results
     *
     * @return self
     */
