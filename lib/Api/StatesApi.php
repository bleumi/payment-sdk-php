...
class StatesApi
{
    ...
    {
        list($response) = $this->listStatesWithHttpInfo();
        return $response;
    }

    /**
     * Operation listStatesWithHttpInfo
     *
     *
     * @throws \Bleumi\Payment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function listStatesWithHttpInfo()
    {
        $request = $this->listStatesRequest();
     ...
     */
    public function listStatesAsync()
    {
        return $this->listStatesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listStatesAsyncWithHttpInfo
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listStatesAsyncWithHttpInfo()
    {
        $returnType = 'array<string,array<string,object>>';
        $request = $this->listStatesRequest();
    ...
    /**
     * Create request for operation 'listStates'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listStatesRequest()
    {

        $resourcePath = '/data/states';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
