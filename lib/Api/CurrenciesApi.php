...
class CurrenciesApi
{
     ...
     * @return \Bleumi\Payment\Model\Currency[]
     */
     ...
     * @throws \Bleumi\Payment\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bleumi\Payment\Model\Currency[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCurrenciesWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bleumi\Payment\Model\Currency[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bleumi\Payment\Model\Currency[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Bleumi\Payment\Model\Currency[]';
            $responseBody = $response->getBody();
